...
module.exports = {
	...
	1: { // Lancer
		...
		/*20: { // Menacing Wave / Legacy skill *sad oof violin interpretation*
			0: {
				fixedSpeed: 1,
		...
		27: { // Rallying Cry
			0: { // Same animation as guardian shout, just slower <- what??
				length: 620,
				noInterrupt: [2],
				race: {
	...
	3: { // Berserker / There's a lot of unneeded no interrupts currently since sGrantSkill is emulated now, this applies for all charging skills interactions
		...
		15: { // Vampiric Blow  //         Uncomment this for being able to VB if, a VB chain is avaiable, else, it won't work
			...
			0: {                             //                    2. Must be in combat when used.  
				...
				chains: {
					3: 14, // Hopefully it doesn't cause issues, was 'x-13' before, i don't remember the client attempting to chain outside of 13 though
					10: 14,
					18: 14
				},
				level: [
