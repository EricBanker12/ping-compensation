...
module.exports = function SkillPredictionCore(dispatch) {
	...
	if (dispatch.base.proxyAuthor != "caali")
		utils.writeWarningMessage("You trying to use SP fork with PinkiePie tera-proxy."+
		"\nYou MUST check updates for proxy/script and update them manually."+
		"\nI do not give any guarantees and do not accept claims if you have any problems with not updated module/proxy! (c) SaltyMonkey");
