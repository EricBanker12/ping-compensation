...
class AutoConfigHelper {
	constructor() {
		...
		this.pingCorrectionMethods = {
			0: { serverTimeout: 60, jitterCompensation: false, skillRetryCount: 1, skillRetryMs: 20, skillDelayOnFail: false },
			1: { serverTimeout: 80, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 25, skillDelayOnFail: true },
			2: { serverTimeout: 110, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 25, skillDelayOnFail: true },
			3: { serverTimeout: 110, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 30, skillDelayOnFail: true },
			4: { serverTimeout: 110, jitterCompensation: true, skillRetryCount: 2, skillRetryMs: 30, skillDelayOnFail: true },
	}
	}
