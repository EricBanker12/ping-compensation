...
class AutoConfigHelper {
	constructor() {
		...
		this.pingCorrectionMethods = {
			0: { serverTimeout: 80, jitterCompensation: false, skillRetryCount: 0, skillRetryMs: 25, skillDelayOnFail: false },
			1: { serverTimeout: 110, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 25, skillDelayOnFail: true },
			2: { serverTimeout: 175, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 25, skillDelayOnFail: true },
			3: { serverTimeout: 215, jitterCompensation: true, skillRetryCount: 1, skillRetryMs: 30, skillDelayOnFail: true },
			4: { serverTimeout: 500, jitterCompensation: true, skillRetryCount: 2, skillRetryMs: 30, skillDelayOnFail: true },
		}
		//Writer(Analyze(), path);
	}
