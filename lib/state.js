...
class State extends EventEmitter {
	constructor() {
		...
		Object.assign(this, {
			...
			presetPcPath: utils.getFullPath("../config/preset.js"),
			presetKrPath: utils.getFullPath("../config/preset.kr.js"),
			presetClassicPath: utils.getFullPath("../config/preset.classic.js"),
			defaultConfigPath: utils.getFullPath("../config/data/default-config.json"),
			skillsPcPath: utils.getFullPath("../config/data/skills.js"),
			skillsKrPath: utils.getFullPath("../config/data/skills.kr.js"),
			skillsClassicPath: utils.getFullPath("../config/data/skills.classic.js"),
	...
	LoadSkillsByPatch(mod) {
		if(mod.isClassic) {
			this.preset = require(this.presetClassicPath);
			this.skills = require(this.skillsClassicPath);
		}
		else if(mod.majorPathVersion >= 75) {
			this.preset = require(this.presetKrPath);
			this.skills = require(this.skillsKrPath);
		}
		else
		{
			this.preset = require(this.presetPcPath);
			this.skills = require(this.skillsPcPath);
		}
