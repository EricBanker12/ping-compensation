...
class State extends EventEmitter {
	constructor() {
		...
		Object.assign(this, {
			...
			presetAwokeOne: utils.getFullPath("../config/preset.awoke1.js"),
			...
			skillsAwokeOne: utils.getFullPath("../config/data/skills.awoke1.js"),
	...
	LoadSkillsByPatch(mod) {
		...
		{
			this.preset = require(this.presetAwokeOne);
			this.skills = require(this.skillsAwokeOne);
			if(!this.preset[4][4] || !this.preset[4][33]){
				this.preset[4][4] = false;
				this.preset[4][33] = false;
			}
