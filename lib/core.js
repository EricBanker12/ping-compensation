...
module.exports = function SkillPrediction(dispatch) {
	state.LoadSkillsByPatch(dispatch.base.majorPatchVersion);
	...
	function sendCannotStartSkill(skill) {
		dispatch.toClient("S_CANNOT_START_SKILL", def.getVersion("S_CANNOT_START_SKILL",dispatch), {skill: skill.id});
	}
