...
class SPPlayer {
	constructor(dispatch) {
		...
		dispatch.hook('S_LOGIN', 10, HOOK_LAST, event => {
			Object.assign(this, {
				gameId: event.gameId,
		...
		dispatch.hook('S_PLAYER_STAT_UPDATE', 9, HOOK_LAST, event => {
			Object.assign(this, {
		...
		dispatch.hook('S_PLAYER_CHANGE_STAMINA', 1, HOOK_LAST, event => { this.stamina = event.current })
	}
}
